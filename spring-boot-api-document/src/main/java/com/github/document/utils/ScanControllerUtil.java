...
import com.github.document.annotation.ApiController;
import com.github.document.annotation.ApiHeadParam;
import com.github.document.annotation.ApiHeader;
import com.github.document.annotation.ApiHeaderCancel;
import com.github.document.annotation.ApiMethod;
import com.github.document.annotation.ApiParams;
import com.github.document.annotation.ApiResponseHides;
import com.github.document.annotation.ApiResponses;
import com.github.document.model.vo.ControllerVo;
import com.github.document.model.vo.HeadVo;
import com.github.document.model.vo.InterfaceVo;
...
public class ScanControllerUtil {
	...
	public static void main(String[] args) {
		ScanControllerUtil.scan("com.sy.controller", "");
	}
				...
				for (Method method : methods) {
					...
					if (null != ivo) {
						...
						if (null != cvo.getUris() && cvo.getUris().size() > 0) {
							...
							//System.out.println(" -- " + method.getName() + " -- " + JSON.toJSONString(ivo.getHeads()));
							interfaces.add(ivo);
						}
